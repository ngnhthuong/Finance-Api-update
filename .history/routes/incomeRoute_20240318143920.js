...
router.get("/getIncomesByCurrentMonth/:userId", incomeController.getIncomesByCurrentMonth)
router.get("/getTotalIncomesMonthByYear/:userId/:year", incomeController.getTotalIncomesMonthByYear)
router.get("/getIncomeByMonthAndYear/:userId/:month/:year", incomeController.getIncomeByMonthAndYear)
